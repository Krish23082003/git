...
async function generateBlogContent() {
  try {
    ...
    const introductionPrompt =
      ...
      Include what the topic is about and what the blog will cover. Add an oroginal quote related to topic or someone's quotation with their name in a specific font style.
